!(function (t) {
  ...
  var e = {
    ...
    icon_type: "class",
    template:
      '<div data-notify="container" class="col-xs-11 col-sm-4 alert alert-{0}" role="alert" style="width: 400px;"><span class="w-20" data-notify="icon"></span> <span class="w-80" data-notify="title">{1}</span> <span data-notify="message">{2}</span><div class="progress" data-notify="progressbar"><div class="progress-bar progress-bar-{0}" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"></div></div><a href="{3}" target="{4}" data-notify="url"></a></div>',
  };
    ...
    t.extend(s.prototype, {
      init: function () {
        ...
        this.buildNotify(),
          ...
          (this.notify = {
            ...
            update: function (s, e) {
              var i = {};
              for (var n in ("string" == typeof s ? (i[s] = e) : (i = s), i))
                switch (n) {
                  case "type":
      ...
      placement: function () {
        ...
        switch (
          ...
          !0 === this.settings.newest_on_top && (e = this.settings.offset.y),
