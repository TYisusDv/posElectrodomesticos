class Charts {
        ...
        data: {
          ...
          datasets: [
            ...
            },
            {
              ...
              backgroundColor: "rgba(" + Globals.tertiaryrgb + ",0.1)",
              borderColor: Globals.tertiary,
              data: [{ x: 190, y: 68, r: 20 }],
            },
          ],
        },
        options: {
          plugins: { crosshair: !1, datalabels: { display: !1 } },
          title: { display: !0, text: "Consumption" },
          responsive: !0,
          maintainAspectRatio: !1,
          scales: {
            yAxes: [
              {
                scaleLabel: { display: !0, labelString: "Fat" },
                ticks: {
                  beginAtZero: !0,
                  stepSize: 20,
                  min: 0,
            ...
            xAxes: [
              {
                scaleLabel: { display: !0, labelString: "Calories" },
  ...
  _initHorizontalRoundedBarChart() {
    if (document.getElementById("horizontalRoundedBarChart")) {
      const t = document
        .getElementById("horizontalRoundedBarChart")
        .getContext("2d");
                ...
                if (
                  ...
                  (o.style = "color: " + t.labelColors[0].borderColor),
                    ...
                    (a.querySelector(".text").innerHTML =
                      r._data.labels[e].toLocaleUpperCase()),
                    (a.querySelector(".value").innerHTML =
                      r._data.datasets[0].data[e]);
                }
              ...
              if (0 !== t.opacity) {
                if (
                  ...
                  (a.querySelector(".icon-container").style =
                    ...
                    new AcornIcons().replace(),
                    (a.querySelector(".text").innerHTML =
                      r._data.datasets[o].label.toLocaleUpperCase()),
                    (a.querySelector(".value").innerHTML =
                      r._data.datasets[o].data[e]);
                }
      ...
      (this._customLegendBar = new Chart(t, {
        ...
        options: {
          ...
          scales: {
            ...
            xAxes: [
              { stacked: !0, gridLines: { display: !1 }, barPercentage: 0.5 },
            ],
          },
          legend: !1,
          legendCallback: function (t) {
            const a = t.canvas.parentElement.parentElement.querySelector(
              ".custom-legend-container"
            );
            a.innerHTML = "";
            const r = t.canvas.parentElement.parentElement.querySelector(
              ".custom-legend-item"
            );
            for (let l = 0; l < t.data.datasets.length; l++) {
              ...
              (e.querySelector(".text").innerHTML =
                t.data.datasets[l].label.toLocaleUpperCase()),
                (e.querySelector(".value").innerHTML = o),
                (e.querySelector(".value").style =
                  "color: " + t.data.datasets[l].borderColor + "!important"),
                (e.querySelector(".icon-container").style =
                  "border-color: " +
                  t.data.datasets[l].borderColor +
                  "!important"),
                (e.querySelector(".icon").style =
                  "color: " + t.data.datasets[l].borderColor + "!important"),
                e
                  .querySelector(".icon")
                  .setAttribute("data-acorn-icon", t.data.icons[l]),
                e.querySelector("a").addEventListener("click", (a) => {
                  a.preventDefault();
                  const r = t.getDatasetMeta(l).hidden;
                  (t.getDatasetMeta(l).hidden = !r),
                    a.currentTarget.classList.contains("opacity-50")
                      ? a.currentTarget.classList.remove("opacity-50")
                      : a.currentTarget.classList.add("opacity-50"),
                    t.update();
                }),
                a.appendChild(e);
            }
  ...
  _initCustomLegendDoughnut() {
    if (document.getElementById("customLegendDoughnutChart")) {
      const t = document
        .getElementById("customLegendDoughnutChart")
        .getContext("2d");
        ...
        options: {
          ...
          legendCallback: function (t) {
            ...
            for (let o = 0; o < t.data.datasets[0].data.length; o++) {
              var e = r.content.cloneNode(!0);
              (e.querySelector(".text").innerHTML =
                t.data.labels[o].toLocaleUpperCase()),
                (e.querySelector(".value").innerHTML =
                  t.data.datasets[0].data[o]),
                (e.querySelector(".value").style =
                  "color: " + t.data.datasets[0].borderColor[o] + "!important"),
                (e.querySelector(".icon-container").style =
                  "border-color: " +
                  t.data.datasets[0].borderColor[o] +
                  "!important"),
                (e.querySelector(".icon").style =
                  "color: " + t.data.datasets[0].borderColor[o] + "!important"),
                e
                  .querySelector(".icon")
                  .setAttribute("data-acorn-icon", t.data.icons[o]),
                e.querySelector("a").addEventListener("click", (a) => {
                  a.preventDefault();
  ...
  _initSmallDoughnutCharts() {
    document.getElementById("smallDoughnutChart1") &&
      (this._smallDoughnutChart1 = ChartsExtend.SmallDoughnutChart(
        "smallDoughnutChart1",
        [14, 0],
        "PURCHASING"
      )),
      document.getElementById("smallDoughnutChart2") &&
        (this._smallDoughnutChart2 = ChartsExtend.SmallDoughnutChart(
          "smallDoughnutChart2",
          [12, 6],
          "PRODUCTION"
        )),
      document.getElementById("smallDoughnutChart3") &&
        (this._smallDoughnutChart3 = ChartsExtend.SmallDoughnutChart(
          "smallDoughnutChart3",
          [22, 8],
          "PACKAGING"
        )),
      document.getElementById("smallDoughnutChart4") &&
        (this._smallDoughnutChart4 = ChartsExtend.SmallDoughnutChart(
          "smallDoughnutChart4",
          [1, 5],
          "DELIVERY"
        )),
      document.getElementById("smallDoughnutChart5") &&
        (this._smallDoughnutChart5 = ChartsExtend.SmallDoughnutChart(
          "smallDoughnutChart5",
          [4, 6],
          "EDUCATION"
        )),
      document.getElementById("smallDoughnutChart6") &&
        (this._smallDoughnutChart6 = ChartsExtend.SmallDoughnutChart(
          "smallDoughnutChart6",
          [3, 8],
          "PAYMENTS"
        ));
