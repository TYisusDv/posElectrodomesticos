class Nav {
  ...
  _init() {
    (this.mobileButton = this.element.querySelector("#mobileMenuButton")),
      ...
      (this._onHorizontalMenuDropdownHidden =
        this._onHorizontalMenuDropdownHidden.bind(this)),
      (this._onHorizontalMenuDropdownClick =
        this._onHorizontalMenuDropdownClick.bind(this)),
  ...
  _initMenuVariables() {
    (this.menuVertical = document.createElement("DIV")),
      ...
      this.menuSideInner &&
        ("mobile" == this.html.getAttribute("data-dimension")
          ? ((this.menuVertical = document.createElement("DIV")),
          ...
          : ((this.menuVertical = document.createElement("DIV")),
            (this.menuVertical.innerHTML =
              '<ul id="menu" class="menu">' + this.menuPlainInner + "</ul>"),
            (this.menuVertical = this.menuVertical.firstChild)));
  }
  _addListeners() {
    window.addEventListener("click", (e) => {
      ...
      this.html.addEventListener(Globals.menuPlacementChange, (e) =>
        this._onMenuPlacementChange(e)
      ),
      this.html.addEventListener(Globals.menuBehaviourChange, (e) =>
        this._onMenuBehaviourChange(e)
      ),
      this.colorButton &&
        this.colorButton.addEventListener("click", (e) => {
          this._onColorClick(e);
        }),
      this.mobileButton &&
  ...
  _addVerticalMenu() {
    document.querySelector("#menu").remove(), this._initMenuVariables();
    this.menuVertical.querySelectorAll("a").forEach((e) => {
      e.nextElementSibling &&
        ...
        e.getAttribute("data-bs-target") &&
          e.nextElementSibling.setAttribute(
            "id",
            e.getAttribute("data-bs-target").substring(1)
          ));
    }),
  ...
  _initVerticalMenu() {
    this._removeHorizontalMenuListeners(), this._addVerticalMenuListeners();
  ...
  _initOtherDropdownsVertical() {
    this.userDropdown && this.userDropdown.dispose(),
      ...
      document.querySelector(".user-container .user") &&
        (this.userDropdown = new bootstrap.Dropdown(
          document.querySelector(".user-container .user"),
          {
      ...
      document.querySelector(".language-switch-container .language-button") &&
        (this.languageDropdown = new bootstrap.Dropdown(
          document.querySelector(".language-switch-container .language-button"),
          {
            popperConfig: function (e) {
              return { placement: "bottom" };
      ...
      document.querySelector(".menu-icons .notification-button") &&
        (this.notificationDropdown = new bootstrap.Dropdown(
          document.querySelector(".menu-icons .notification-button"),
          {
  ...
  _addVerticalMenuListeners() {
    this._removeVerticalMenuListeners(),
      document.querySelectorAll("#menu .collapse").forEach((e) => {
        e.addEventListener("show.bs.collapse", this._onCollapseShow);
      }),
      document.querySelectorAll("#menu .collapse").forEach((e) => {
        e.addEventListener("hide.bs.collapse", this._onCollapseHide);
      }),
      document.querySelectorAll("#menu .collapse").forEach((e) => {
        e.addEventListener("shown.bs.collapse", this._onCollapseShown);
      }),
      document
        .querySelector("#menu")
        .addEventListener("click", this._onVerticalMenuClick);
  }
  _removeVerticalMenuListeners() {
    document
      .querySelector("#menu")
      .removeEventListener("click", this._onVerticalMenuClick),
      document.querySelectorAll("#menu .collapse").forEach((e) => {
        e.removeEventListener("show.bs.collapse", this._onCollapseShow);
      }),
      document.querySelectorAll("#menu .collapse").forEach((e) => {
        e.removeEventListener("hide.bs.collapse", this._onCollapseHide);
      }),
      document.querySelectorAll("#menu .collapse").forEach((e) => {
        e.removeEventListener("shown.bs.collapse", this._onCollapseShown);
      });
  }
  _onCollapseHide(e) {
    const t = e.target.previousElementSibling;
    t && "A" === t.tagName && t.setAttribute("aria-expanded", !1);
  }
  _onCollapseShow(e) {
    const t = e.target.previousElementSibling;
    t && "A" === t.tagName && t.setAttribute("aria-expanded", !0);
  }
  _onCollapseShown(e) {
    const t = e.target.previousElementSibling;
    t && "A" === t.tagName && t.setAttribute("data-clicked", !0);
  }
  _onVerticalMenuClick(e) {
    const t = e.target.closest("a");
    t &&
      "true" === t.getAttribute("data-clicked") &&
      t.removeAttribute("data-clicked");
  }
  _addHorizontalMenu() {
    document.querySelector("#menu").remove(), this._initMenuVariables();
    const e = this.menuHorizontal;
    e.querySelectorAll("li").forEach((e) => {
      e.querySelector(":scope > ul") && e.classList.add("dropdown");
    }),
      e.querySelectorAll(":scope > li").forEach((e) => {
        let t = "a";
        if (e.classList.contains("mega")) {
          t = ":scope > a";
          const i = e.querySelectorAll(":scope > ul>li").length;
          e.querySelectorAll(":scope > ul").forEach((e) => {
            e.classList.add("row"),
        ...
        e.querySelectorAll(t).forEach((e) => {
          ...
          e.querySelectorAll("a").forEach((e) => {
            e.nextElementSibling &&
              "UL" === e.nextElementSibling.tagName &&
              e.classList.add("dropdown-toggle");
          }),
          e.querySelectorAll(":scope > a").forEach((e) => {
            e.nextElementSibling &&
              "UL" === e.nextElementSibling.tagName &&
              e.setAttribute("data-bs-toggle", "dropdown");
          });
      }),
      this.menuContainer.insertAdjacentElement(
        "beforeend",
        this.menuHorizontal
      ),
      document.querySelector("#menu").classList.add("show"),
  ...
  _removeHorizontalMenuListeners() {
    document.querySelectorAll("#menu > li").forEach((e) => {
      ...
      document
        .querySelectorAll("#menu .dropdown-menu a.dropdown-toggle")
        .forEach((e) => {
          e.removeEventListener("click", this._onHorizontalMenuDropdownClick);
        });
  }
  _addHorizontalMenuListeners() {
    this._removeHorizontalMenuListeners(),
      ...
      document
        .querySelectorAll("#menu .dropdown-menu a.dropdown-toggle")
        .forEach((e) => {
          e.addEventListener("click", this._onHorizontalMenuDropdownClick);
        });
  }
  _onHorizontalMenuDropdownClick(e) {
    const t = e.currentTarget;
    e.stopPropagation(), e.preventDefault();
    const i = t.closest(".dropdown-menu").querySelector(".show");
    return (
      i &&
        !t.nextElementSibling.classList.contains("show") &&
        (i.classList.remove("show"),
        i.querySelectorAll(".dropdown").forEach((e) => {
          e.classList.remove("show");
        }),
        i.querySelectorAll(".dropdown-menu").forEach((e) => {
          e.classList.remove("show");
        })),
      "UL" === t.nextElementSibling.tagName &&
        (t.nextElementSibling.classList.contains("show")
  ...
  _onHorizontalMenuDropdownHidden(e) {
    this._hideDropdowns();
  }
  _matchUrl() {
    this.settings.matchUrl &&
      (this._matchUrlByMenu("#menu"), this._matchUrlByMenu("#menuSide"));
  }
  _matchUrlByMenu(e) {
    ...
    let i;
    if (
      (document.querySelectorAll(e + " a").forEach((e) => {
        const n = e
            .getAttribute("href")
            .toLowerCase()
            .replace(/^\/+/g, "")
          ...
          o =
            ...
            e
              ...
              .replace(/^\/+/g, "")
              .replace(/\.[^/.]+$/, "");
        (t.includes(n) || t.includes(o)) &&
          (e.classList.add("active"), (i = e));
      }),
      i)
    ) {
      for (var n = [], o = i; o && !(o = o.parentNode).matches(e); )
        o.matches("ul") && n.unshift(o);
      n.forEach((e) => {
        e.previousElementSibling.matches("a") &&
  ...
  _onWindowClick(e) {
    this.element.classList.contains("mobile-side-in") &&
      !e.target.closest("#nav") &&
      this._hideMobileMenu();
  }
  _initMenuPlacement() {
    var e = window.innerWidth,
      t = this.placementStatus;
    this._hideOtherDropdownsVertical(),
      "horizontal" === this.selectedMenuPlacement &&
        (this.horizontalMobile > e
          ? 1 !== this.placementStatus &&
      ...
      "vertical" === this.selectedMenuPlacement &&
        (this.verticalMobile > e
          ? 3 !== this.placementStatus &&
            (this.html.setAttribute("data-dimension", "mobile"),
            this.html.setAttribute("data-placement", "horizontal"),
            this._addVerticalMenu(),
            (this.placementStatus = 3),
            this._dispatchMobileEvent())
          : 4 !== this.placementStatus &&
            (this._hideMobileMenuQuick(),
            this.html.setAttribute("data-dimension", "desktop"),
  ...
  _initMenuBehaviour() {
    var e = this.behaviourStatus,
      t = window.innerWidth,
      i = this.html.getAttribute("data-placement");
    "vertical" === i &&
      "unpinned" === this.selectedMenuBehaviour &&
      (this.verticalMobile > t || this.verticalUnpinned <= t
        ? 1 !== this.behaviourStatus &&
          (this.verticalUnpinned !== this.verticalMobile
          ...
          this._hideShowMenu())
        : 2 !== this.behaviourStatus &&
          (this.html.setAttribute("data-behaviour", "unpinned"),
          this._disablePinButton(),
          (this.behaviourStatus = 2),
          this._hideShowMenu())),
      "vertical" === i &&
        "pinned" === this.selectedMenuBehaviour &&
        (this.verticalMobile > t || this.verticalUnpinned <= t
          ? 3 !== this.behaviourStatus &&
            (this.html.setAttribute("data-behaviour", "pinned"),
            this._enablePinButton(),
            (this.behaviourStatus = 3),
            this._unCollapseMenu())
          : 4 !== this.behaviourStatus &&
            (this.html.setAttribute("data-behaviour", "unpinned"),
            this._disablePinButton(),
      ...
      "horizontal" === i &&
        "unpinned" === this.selectedMenuBehaviour &&
        5 !== this.behaviourStatus &&
        (this.html.setAttribute("data-behaviour", "unpinned"),
        this._enablePinButton(),
        (this.behaviourStatus = 5)),
      "horizontal" === i &&
        "pinned" === this.selectedMenuBehaviour &&
        6 !== this.behaviourStatus &&
        (this.html.setAttribute("data-behaviour", "pinned"),
        this._enablePinButton(),
  ...
  _collapseMenu() {
    document.querySelectorAll("#menu>li>a").forEach((e) => {
      if ("true" === e.getAttribute("data-clicked")) {
        const t = bootstrap.Collapse.getInstance(e.nextElementSibling);
        t && t.hide();
      }
    }),
      this._hideDropdowns();
  ...
  _hideDropdowns() {
    [].slice
      .call(
        document.querySelectorAll('#menu>li>ul [data-bs-toggle="dropdown"]')
      )
      .map(function (e) {
        if (e.classList.contains("show")) {
          const t = bootstrap.Dropdown.getInstance(e);
          t && t.hide();
        }
      }),
  ...
  _hideShowMenu() {
    if (
      "vertical" === this.html.getAttribute("data-placement") &&
      "true" !== this.html.getAttribute("data-mobile") &&
      "unpinned" === this.html.getAttribute("data-behaviour")
    ) {
      var e = !1;
      if (
        (document.querySelectorAll("#menu>li>a").forEach((t) => {
          t.nextElementSibling &&
            "UL" === t.nextElementSibling.tagName &&
            t.nextElementSibling.classList.contains("collapsing") &&
            (e = !0);
        }),
        e)
      )
        return void this._hideShowMenuDelayed();
      "show" === this.html.getAttribute("data-menu-animate")
        ? this._unCollapseMenu()
        : this._collapseMenu();
    }
  ...
  _onMenuPlacementChange(e) {
    (this.selectedMenuPlacement = e.detail), this._initMenuPlacement();
  }
  _onMenuBehaviourChange(e) {
    (this.selectedMenuBehaviour = e.detail), this._initMenuBehaviour();
  }
  _onWindowScroll(e) {
  ...
  _onWindowScrollInterval() {
    if (this.windowScrolled) {
      ...
      if (
        ((this.windowScrolled = !1),
        Math.abs(this.prevScrollpos - e) <= t && e > t)
      )
        return void (this.prevScrollpos = e);
      "horizontal" === this.html.getAttribute("data-placement") &&
        "true" !== this.html.getAttribute("data-mobile") &&
        "unpinned" === this.html.getAttribute("data-behaviour") &&
        (this.prevScrollpos > e || e <= t
  ...
  _onPinClick(e) {
    e.preventDefault(),
      this.pinButton.classList.contains("disabled") ||
